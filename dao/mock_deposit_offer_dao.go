...
//
//	mockgen -package=dao -destination=dao/mock_deposit_offer_dao.go github.com/chain4travel/camino-signavault/dao DepositOfferDao
//
...
func (mr *MockDepositOfferDaoMockRecorder) AddSignatures(arg0, arg1, arg2 any) *gomock.Call {
...
func (mr *MockDepositOfferDaoMockRecorder) GetSignatures(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
